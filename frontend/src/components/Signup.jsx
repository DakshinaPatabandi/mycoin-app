...
function Signup() {
  ...
  return (
    <>
    <h1 className="topic mt-5">Create your account</h1>
    <div className="container mt-2 justify-content-center align-items-center d-flex  ">
    <div className="mt-5  justify-content-center align-items-center rounded-2 p-5 bg-secondary">
        <form action="" onSubmit={handleSubmit}>
            ...
            <div class="mb-3">
                <label  className="form-label color-white"><strong>Email</strong></label>
                <input 
                    type="text"
                    required 
                    name="email"
            ...
            <NavLink to='/login' className='btn btn-default border'><strong>Back To Login</strong></NavLink>
